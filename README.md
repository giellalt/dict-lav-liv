# Dictionary for lav — liv

This repository contains source files for a dictionary from Latvian to Liv (Livonian). The content is licensed under the CC-BY-4.0 license.
